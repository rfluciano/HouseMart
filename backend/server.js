...
// app.use('/api/with/:id', (req, res) => {
//   const { id } = req.params;

//   // Réponse pour les requêtes génériques lorsque l'ID est fourni
//   return res.status(200).json({
//     // message: `Aucune maison trouvée pour le IdVendeur ${id}`,
//     data: []
//   });
// });
...
const house = require("./routes/houseRoutes.js");
app.use("/api", house);
